...
public class MpvUsuaios {
    ...
    /**
     * @return the mvpApelido
     */
    public String getMvpApelido() {
        return mvpApelido;
    }

    /**
     * @param mvpApelido the mvpApelido to set
     */
    public void setMvpApelido(String mvpApelido) {
        this.mvpApelido = mvpApelido;
    }
